...
def get_max_count_to_down(pyramid: str = '') -> int:
    pyramid = pyramid or p
    _lst_prd = [i for i in pyramid.split('     ')]
    list_prd = [list(map(lambda x: int(x), x.split(' '))) for x in _lst_prd]
    result = list_prd[0][0]
